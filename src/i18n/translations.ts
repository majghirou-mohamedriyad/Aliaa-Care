...
const translations = {
  ...
  "common.explore": { fr: "Explorer", en: "Explore", ar: "استكشف" },
  "common.new": { fr: "Nouveau", en: "New", ar: "جديد" },
  "common.featured": { fr: "Vedette", en: "Featured", ar: "مميز" },
  "common.all": { fr: "Tous", en: "All", ar: "الكل" },
  "common.contactUs": { fr: "Contactez-Nous", en: "Contact Us", ar: "اتصل بنا" },
  "common.back": { fr: "Retour", en: "Back", ar: "رجوع" },
  "common.stayConnected": { fr: "Restez Connectée", en: "Stay Connected", ar: "ابق على تواصل" },
  ...
  "common.save": { fr: "Économisez", en: "Save", ar: "وفّر" },
  ...
  "hero.scroll": { fr: "Scroll", en: "Scroll", ar: "مرّر" },
  ...
  "index.featuredDesc": {
    ...
    ar: "امنح نفسك لحظة من الرفاهية مع مجموعتنا من المنتجات الطبيعية، مقدمة في علبة هدايا أنيقة.",
  },
  "index.discoverCollection": { fr: "Découvrir les", en: "Discover the", ar: "اكتشف" },
  ...
  "index.browseBy": { fr: "Parcourir Par", en: "Browse By", ar: "تصفح حسب" },
  ...
  "index.followUs": { fr: "Suivez-Nous", en: "Follow Us", ar: "تابعنا" },
  "index.followDesc": {
  ...
  "products.needAdvice": { fr: "Besoin de Conseils ?", en: "Need Advice ?", ar: "تحتاج نصيحة؟" },
  ...
  "trackOrder.desc": { fr: "Entrez votre numéro de commande pour voir l'état de votre livraison en temps réel.", en: "Enter your order number to see the status of your delivery in real time.", ar: "أدخل رقم طلبك لمعرفة حالة التوصيل في الوقت الفعلي." },
  ...
  "trackOrder.needHelp": { fr: "Besoin d'aide ?", en: "Need help?", ar: "تحتاج مساعدة؟" },
  ...
  "trackOrder.contactWhatsApp": { fr: "Nous contacter sur WhatsApp", en: "Contact us on WhatsApp", ar: "تواصل معنا عبر الواتساب" },
  ...
  "trackOrder.discoverNew": { fr: "Découvrir nos nouveautés", en: "Discover our novelties", ar: "اكتشف جديدنا" },
  ...
  "cart.emptyDesc": {
    ...
    ar: "اكتشف مجموعتنا من المنتجات الطبيعية وجدي ما يناسبك.",
  },
  "cart.startShopping": { fr: "Commencer vos achats", en: "Start Shopping", ar: "ابدئ التسوق" },
  ...
  "checkout.contactPhone": { fr: "Contactez-nous au", en: "Contact us at", ar: "تواصل معنا على" },
  ...
  "wishlist.empty": { fr: "Vous n'avez pas encore de produits sauvegardés.", en: "You haven't saved any products yet.", ar: "لم تحفظ أي منتجات بعد." },
  "wishlist.emptyDesc": { fr: "Explorez notre boutique et sauvegardez vos coups de cœur.", en: "Explore our shop and save your favorites.", ar: "استكشف متجرنا واحفظي ما يعجبك." },
  "wishlist.discoverShop": { fr: "Découvrir la Boutique", en: "Discover the Shop", ar: "اكتشف المتجر" },
  ...
  "about.ctaTag": { fr: "Contactez-Nous", en: "Contact Us", ar: "اتصل بنا" },
  ...
  "about.writeUs": { fr: "Nous Écrire", en: "Write to Us", ar: "راسلنا" },
  ...
  // Footer
  "footer.explore": { fr: "Explorer", en: "Explore", ar: "استكشف" },
  ...
  "checkout.promoPlaceholder": { fr: "Entrez votre code", en: "Enter your code", ar: "أدخل الرمز" },
  ...
  // Language selector
  "lang.chooseLanguage": { fr: "Choisissez votre langue", en: "Choose your language", ar: "اختار لغتك" },
